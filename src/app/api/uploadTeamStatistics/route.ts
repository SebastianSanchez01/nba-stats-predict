...
export async function POST() {
  try {
    ...
    const teamID = 40;
    const url = 'https://api-nba-v1.p.rapidapi.com/teams/statistics?id=' + teamID + '&season=2024';
    const options = {
      method: 'GET',
      headers: {
    ...
    return new Response(JSON.stringify({ message: 'Teams uploaded successfully!' + result }), { status: 200 });
